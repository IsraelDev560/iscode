...
export const Apresentation = () => {
    ...
    return (
        <div className="flex flex-col justify-between lg:flex-row w-full max-w-5xl mt-32 lg:items-start items-center mx-auto p-6 lg:p-0">
            <div className="text-left text-black dark:text-white space-y-2">
                ...
                <p className="z-10 relative py-6 text-lg text-gray-900 dark:text-gray-400 max-w-lg">
            ...
            <div className='absolute z-[0] w-[45%] h-[45%] bg-gradient-to-r from-pink-200 right-10 dark:bg-gradient-to-r dark:from-indigo-500 blur-3xl rounded-full' />
        </div>
    )
}