...
export const About = () => {
    ...
    return(
        ...
        <div className="text-center items-center justify-center mx-auto mt-5 space-y-2">
            <h2 className="text-xl font-semibold text-white">Olá, eu sou</h2>
            ...
            <span className='text-lg leading-relaxed text-white max-w-xs'>
                ...
                <AnimatePresence>
                    {moreText && (
                        <motion.div
                            ...
                            className="w-full z-0 text-white max-w-xs"
                        >
                            <p>
            ...
            {/* <h2 className='text-xl text-white text-center'>Minhas redes Sociais</h2> */}
        </div>
    </div>
    )
}